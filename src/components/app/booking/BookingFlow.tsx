...
export function BookingFlow({ proId }: { proId: string }) {
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-[600px] flex-col px-5 md:my-10 md:min-h-[82vh] md:rounded-[32px] md:border md:border-[var(--blyss-border)] md:bg-[color-mix(in_srgb,white_45%,var(--background))] md:px-9 md:py-2 md:shadow-[var(--shadow-card)]">
      <RibbonSweep />
      {step !== 'confirm' && (
        <div className="py-4">
          <button
